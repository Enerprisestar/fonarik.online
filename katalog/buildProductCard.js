...
function renderCardProduct(text, price, linkImg,linkPageProduct,id) {
    ...
    let catalogcardheaderwrapper = document.createElement("div");
    catalogcardheaderwrapper.classList.add("catalog-card_header__wrapper");
    ...
    catalogcardheaderwrapper.appendChild(catalogcardheader)
    catalogggg.appendChild(catalogcardimg);
    catalogggg.appendChild(catalogcardheaderwrapper);
